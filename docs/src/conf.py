...
# -*- coding: utf-8 -*-
#
# Connext documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'connext', 'Connext Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Connext', 'Connext Documentation',
     author, 'Connext', 'One line description of project.',
     'Miscellaneous'),
]
