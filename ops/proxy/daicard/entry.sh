...
if [[ "${DAICARD_INDRA_URL%%://*}" == "https" ]]
then export DAICARD_INDRA_PROTOCOL="ssl"
else export DAICARD_INDRA_PROTOCOL=""
fi

DAICARD_INDRA_URL=${DAICARD_INDRA_URL#*://}

if [[ "$DAICARD_INDRA_PROTOCOL" == "ssl" ]]
then export DAICARD_INDRA_HOST="${DAICARD_INDRA_URL%%/*}:443"
else export DAICARD_INDRA_HOST="${DAICARD_INDRA_URL%%/*}"
fi

export DAICARD_WEB_SERVER_HOST=${DAICARD_WEB_SERVER_URL#*://}
...
echo "DAICARD_INDRA_PROTOCOL=$DAICARD_INDRA_PROTOCOL"
