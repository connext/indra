...
export async function runWithdrawProtocol(requestHandler: RequestHandler, params: CFCoreTypes.WithdrawParams) {
  ...
  await protocolRunner.initiateProtocol(Protocol.Withdraw, new Map([[stateChannel.multisigAddress, stateChannel]]), {
    amount,
    tokenAddress,
