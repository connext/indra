...
exports.up = function(db) {
  return db.runSql(`
    ALTER TABLE ledger_channel_state_updates RENAME COLUMN price TO price_wei;
    ALTER TABLE virtual_channel_state_updates RENAME COLUMN price TO price_wei;
    ...
    ALTER TABLE ledger_channel_state_updates ADD COLUMN price_erc20 token_amount;
    ALTER TABLE virtual_channel_state_updates ADD COLUMN price_erc20 token_amount;
