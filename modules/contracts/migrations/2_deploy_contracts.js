...
// ATTENTION: These migrations are depreciated and probably don't work anymore
// Migrations are handled automatically when you run `make start` or `npm start` from Indra
// To migrate manually or to mainnet:
// Run `bash ops/deploy-contracts.sh <network>` from the Indra project root instead
// Where network can be one of: ["ganache", "rinkeby", "mainnet"]
