...
contract MixinSetState is LibStateChannelApp, MChallengeRegistryCore {
  ...
  function setState(AppIdentity memory appIdentity, SignedAppChallengeUpdate memory req) public {
    ...
    require(req.versionNumber > challenge.versionNumber, "setState was called with outdated state");
