...
contract MixinCancelDispute is LibStateChannelApp, MChallengeRegistryCore {
  ...
  function cancelDispute(AppIdentity memory appIdentity, SignedCancelDisputeRequest memory req)
    public
  ...
  // external
  {
    ...
    require(
      correctKeysSignedCancelChallengeRequest(identityHash, appIdentity.participants, req),
  ...
  function correctKeysSignedCancelChallengeRequest(
    ...
    bytes32 digest = computeCancelDisputeHash(identityHash, req.versionNumber);
