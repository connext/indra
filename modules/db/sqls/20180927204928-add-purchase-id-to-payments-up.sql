...
-- NOTE: This should not have been unique; see 20181004195202-payment-meta-purchase-remove-unique.js
ADD COLUMN purchase varchar(128) UNIQUE;

UPDATE payment_meta
SET purchase = COALESCE(
    paymenttoken,
    'vc:' || vcupdatetoken,
    'lc:' || lcupdatetoken
);
