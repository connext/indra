...
export class MessagingServiceFactory {
  ...
  constructor(private config: MessagingConfig) {
    ...
    if (typeof messagingUrl === "string") {
      this.serviceType = messagingUrl.startsWith("nats://") || messagingUrl.startsWith("tls://") ? "nats" : "ws";
    } else if ((messagingUrl[0] && messagingUrl[0].startsWith("nats://")) || messagingUrl[0].startsWith("tls://")) {
