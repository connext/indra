...
create table payment_profiles (
	...
	minimum_maintained_collateral_wei wei_amount,
  minimum_maintained_collateral_token wei_amount,
	amount_to_collateralize_wei wei_amount,
  amount_to_collateralize_token wei_amount
);
