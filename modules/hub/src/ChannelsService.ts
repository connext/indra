...
export default class ChannelsService {
  ...
  public async calculateCollateralizationTargets(state: ChannelStateBigNumber) {
    ...
    return {
      minAmount: BigNumber.max(baseMin, baseTarget).times(this.config.beiMinCollateralizationMultiple),
      ...
      maxAmount: BigNumber.min(
        ...
        BigNumber.max(
          baseMin,
          baseTarget.times(this.config.beiMaxCollateralizationMultiple),
        ),
      ),
