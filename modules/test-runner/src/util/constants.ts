...
export const NEGATIVE_ONE_ETH = utils.parseEther(NEGATIVE_ONE);
export const NEGATIVE_ZERO_ZERO_ONE_ETH = utils.parseEther(NEGATIVE_ZERO_ZERO_ONE);

export const TEN_ETH = utils.parseEther(TEN);
export const TWO_ETH = utils.parseEther(TWO);
export const ONE_ETH = utils.parseEther(ONE);
export const ZERO_ONE_ETH = utils.parseEther(ZERO_ONE);
export const ZERO_ZERO_TWO_ETH = utils.parseEther(ZERO_ZERO_TWO);
export const ZERO_ZERO_ONE_ETH = utils.parseEther(ZERO_ZERO_ONE);
export const ZERO_ZERO_ZERO_FIVE_ETH = utils.parseEther(ZERO_ZERO_ZERO_FIVE);
export const ZERO_ZERO_ZERO_ONE_ETH = utils.parseEther(ZERO_ZERO_ZERO_ONE);
