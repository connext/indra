...
describe("Deposits", () => {
  ...
  it("happy case: client should request deposit rights and deposit ETH", async (done: jest.DoneCallback) => {
  ...
  // tslint:disable-next-line:max-line-length
  it("happy case: client should request deposit rights and deposit token", async (done: jest.DoneCallback) => {
