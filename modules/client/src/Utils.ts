...
import { ConnextState, getCustodialAndChannelBalance, getExchangeRates } from './state'
import {
...
export class Utils {
  ...
  public getExchangeRates: (state: ConnextState) => ExchangeRates = getExchangeRates
