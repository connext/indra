...
export class renameIdentifiers1586509706761 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "channel" RENAME COLUMN "userPublicIdentifier" TO "userIdentifier"`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "channel" RENAME COLUMN "nodePublicIdentifier" TO "nodeIdentifier"`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "app_instance" RENAME COLUMN "userParticipantAddress" TO "userIdentifier"`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "app_instance" RENAME COLUMN "nodeParticipantAddress" TO "nodeIdentifier"`,
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP VIEW "anonymized_onchain_transaction"`, undefined);
    await queryRunner.query(
      `ALTER TABLE "channel" RENAME COLUMN "userIdentifier" TO "userPublicIdentifier"`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "channel" RENAME COLUMN "nodeIdentifier" TO "nodePublicIdentifier"`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "app_instance" RENAME COLUMN "userIdentifier" TO "userParticipantAddress"`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "app_instance" RENAME COLUMN "nodeIdentifier" TO "nodeParticipantAddress"`,
      undefined,
    );
    await queryRunner.query(
