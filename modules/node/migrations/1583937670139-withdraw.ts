...
export class withdraw1583937670139 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "withdraw" ADD CONSTRAINT "UQ_fe366fd9823feea6af8ad157176" UNIQUE ("onchainTransactionId")`,
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "withdraw" DROP CONSTRAINT "UQ_fe366fd9823feea6af8ad157176"`,
      undefined,
    );
