...
export class RebalancingProfile1581796200880 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`
      ...
      ALTER TABLE "channel_payment_profiles_payment_profile" RENAME COLUMN "paymentProfileId" TO "rebalanceProfileId";
      ALTER TABLE "channel_payment_profiles_payment_profile" RENAME TO "channel_rebalance_profiles_rebalance_profile";
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`
      ...
      ALTER TABLE "channel_rebalance_profiles_rebalance_profile" RENAME TO "channel_payment_profiles_payment_profile";
    `);
  }
}
