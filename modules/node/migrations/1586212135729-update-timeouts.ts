...
export class updateTimeouts1586212135729 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "set_state_commitment" ADD COLUMN "stateTimeout" text NOT NULL`, undefined);
        await queryRunner.query(`ALTER TABLE "set_state_commitment" DROP COLUMN "timeout"`, undefined);
  
        await queryRunner.query(`ALTER TABLE "app_instance" ADD "defaultTimeout" text NOT NULL`, undefined);
        await queryRunner.query(`ALTER TABLE "app_instance" ADD "stateTimeout" text NOT NULL`, undefined);
